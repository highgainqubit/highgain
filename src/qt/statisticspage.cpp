...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " GAIN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " GAIN" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " GAIN");
    }
