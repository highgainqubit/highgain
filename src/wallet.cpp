...
bool CWallet::EncryptWallet(const SecureString& strWalletPassphrase)
{
...

    {
        ...
        SetMinVersion(FEATURE_WALLEGAINYPT, pwalletdbEncryption, true);
...
// highgain: total coins staked (non-spendable until maturity)
...
// highgain: check 'spent' consistency between wallet and txindex
// highgain: fix wallet spent state according to txindex
...
// highgain: disable transaction (only for coinstake)
